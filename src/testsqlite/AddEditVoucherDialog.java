 ...
 * Mirip dengan AddEditBarangDialog: combo box guru diisi dari GuruDAO.
...
public class AddEditVoucherDialog extends JDialog {
    ...
    public AddEditVoucherDialog(Frame parent, Voucher v) {
        ...
        if (v != null) {
            ...
            // default: pilih "Tidak ada" (index 0)
    ...
    private void initUI() {
        ...
        // Renderer supaya combo menunjukkan "id - nama" atau nama saja
            ...
            public Component getListCellRendererComponent(JList<?> list, Object value, int index,
                ...
                if (value instanceof Guru) {
                    ...
                    if (g.getIdGuru() == 0) {
                        ...
                        // tampilkan ringkas: "ID - Nama"
                        setText(String.valueOf(g.getIdGuru()) + " - " + (g.getNamaGuru() == null ? "-" : g.getNamaGuru()));
                    }
                }
                return this;
            }
    ...
    private void loadGuruList() {
        try {
            ...
            Guru none = new Guru();
            none.setIdGuru(0);
            none.setNamaGuru("-"); // tampilkan sebagai "-"
